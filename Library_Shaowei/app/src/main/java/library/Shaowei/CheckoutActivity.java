package library.Shaowei;

/**
 * Created by Shaowei on 3/21/2016.
 */
...
import library.Shaowei.util.Pair;
import library.Shaowei.constant.SQLCommand;
import library.Shaowei.util.DBOperator;
import library.Shaowei.view.ChartGenerator;
...
public class CheckoutActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.checkout_shaowei);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.checkout_btn) {
            ...
            Intent intent = new Intent(this, ShaoweiActivity.class);
